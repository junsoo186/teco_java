...
public class BookProgram {
	...
	public static void main(String[] args) {
		...
		Book bookBox2 = new Book();
			...
			// 참조 타임에 변수안에는 실제 값이 들어가는 것이 아니라
		...
		bookBox1.totalPage = 2022;
		//콘솔창에다가 해당 객체의 속성값(상태값) 을 출력해 보자.
		
		bookBox2.title = "셜록홈즈";
		bookBox2.author= "코난 도일";
		bookBox2.publishYear = 1987;
		bookBox2.totalPage = 545;
		...
		//연습문제
		//bookBox1 클래스 인스턴스에 접근해서 속성값을 대입하고
		//콘솔창 화면에 출력 하시오
